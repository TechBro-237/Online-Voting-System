...
🗳️ Online Voting System 📌 Project Overview
...
🚀 Features User registration and login system Secure authentication Vote casting (one vote per user) Real-time vote counting Admin dashboard for managing elections Candidate management Results display after voting ends Email notifications (via PHPMailer) 🛠️ Tech Stack Frontend: HTML, CSS, JavaScript Backend: PHP Database: MySQL Server: XAMPP / Apache Email Service: PHPMailer

📂 Project Structure Online-Voting-System/ │ ├── admin/ # Admin panel ├── voters/ # Voter interface ├── database/ # SQL file ├── includes/ # Config files ├── PHPMailer/ # Email library ├── tcpdf/ # PDF generation library └── index.php # Entry point

⚙️ Installation Setup

Clone the repository git clone https://github.com/TechBro-237/Online-Voting-System.git

Move to XAMPP directory Place the project inside: C:\xampp\htdocs\

Start server Start Apache and MySQL in XAMPP

Import database Open phpMyAdmin Create a database (e.g. voting_system) Import: DATABASE/voting_system.sql

Run project Open browser: http://localhost/Online-Voting-System/

🔐 Security Features Prevents double voting Session-based authentication Input validation Secure database queries
...
Ndonue Christain Funue (TechBro-237) GitHub: https://github.com/TechBro-237
...
This project is currently unlicensed. All rights reserved by the author. No changes or updates or reuse of this code is permitted. Thanks!!!



https://github.com/TechBro-237/Online-Voting-System.git
